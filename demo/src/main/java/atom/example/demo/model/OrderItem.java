...
public class OrderItem {
    ...
    public atom.example.demo.model.UsedListing getUsedListing() {
        return usedListing;
    }

    public void setUsedListing(atom.example.demo.model.UsedListing usedListing) {
    ...
    public BigDecimal getUnitPriceBdt() {
        return unitPriceBdt;
    }

    public void setUnitPriceBdt(BigDecimal unitPriceBdt) {
