        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center" ref={searchContainerRef}>
            ...
            <button
              ...
              className={`flex h-9 w-9 items-center justify-center rounded-full transition-colors ${searchOpen ? 'bg-[#f9f5f0] text-[#221b16]' : 'text-[#6c5b4f] hover:bg-[#f9f5f0] hover:text-[#221b16]'}`}
            >
