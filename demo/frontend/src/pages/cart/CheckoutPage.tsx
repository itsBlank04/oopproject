        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl animate-[scaleIn_0.2s_ease-out]">
            <div className="px-6 py-5 text-center border-b border-[#e4d6c8]/40">
              ...
              <h2 className="font-semibold text-[#1a1512] text-lg">Order placed!</h2>
              <p className="text-sm text-[#6c5b4f] mt-1">Order #{placedOrderId} has been placed successfully</p>
            </div>
            <div className="px-6 py-5 space-y-3">
              <p className="text-sm font-medium text-[#1a1512]">Choose payment method</p>
              <button onClick={() => setStep('payment')}
                className="w-full flex items-center gap-4 rounded-xl border-2 border-[#1a1512] bg-[#faf6f2] p-4 text-left transition-all hover:bg-[#f0e8df]">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#1a1512]">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-[#1a1512]">Pay Now</p>
              ...
              <button onClick={confirmCod} disabled={processingPayment}
                className="w-full flex items-center gap-4 rounded-xl border-2 border-[#e4d6c8]/60 bg-white p-4 text-left transition-all hover:border-[#b8a494] disabled:opacity-50">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-[#1a1512]">Cash on Delivery</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={() => { setStep('choice'); setPaymentMethod(null) }}>
          <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl animate-[scaleIn_0.2s_ease-out]" onClick={e => e.stopPropagation()}>
            <div className="flex items-center justify-between border-b border-[#e4d6c8]/40 px-6 py-4">
              ...
              <button onClick={() => { setStep('choice'); setPaymentMethod(null) }} className="text-[#8c7564] hover:text-[#1a1512]">
            ...
            <div className="flex items-center gap-3 border-t border-[#e4d6c8]/40 px-6 py-4">
              <button onClick={() => { setStep('choice'); setPaymentMethod(null) }}
                className="flex-1 rounded-xl border border-[#d7c7b8] px-4 py-2.5 text-sm font-medium text-[#6c5b4f] hover:bg-[#f5f0eb] transition-colors">
                Back
              </button>
