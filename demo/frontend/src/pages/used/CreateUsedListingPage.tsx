  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] px-6 py-10">
      <div className="mx-auto max-w-2xl">
        <h1 className="font-[Fraunces] text-3xl text-[#1e293b]">Sell a Used Item</h1>
        <div className="mt-6 space-y-5 rounded-2xl border border-[#e0e7ff] bg-white p-6">
          <div>
            <label className="text-sm font-semibold text-[#1e293b]">Title *</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-sm font-semibold text-[#1e293b]">Asking Price (৳) *</label>
