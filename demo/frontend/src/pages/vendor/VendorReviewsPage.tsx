  ...
  return (
    <div className="min-h-screen bg-[#faf6f2] py-12 px-6">
      <div className="mx-auto max-w-5xl">
        <div className="mb-10">
          <h1 className="font-[Fraunces] text-4xl font-bold text-[#221b16]">Reviews & Reputation</h1>
        ...
        <div className="mb-10 grid gap-6 md:grid-cols-[280px_1fr]">
          <div className="rounded-2xl border border-[#e4d6c8]/60 bg-white p-6 shadow-sm text-center">
            ...
            <p className="font-[Fraunces] text-5xl font-bold text-[#221b16]">{avgRating}</p>
            ...
            {trustScore && (
              <div className="mt-4 rounded-xl bg-[#faf6f2] border border-[#e4d6c8]/40 p-3">
          ...
          <div className="rounded-2xl border border-[#e4d6c8]/60 bg-white p-6 shadow-sm">
            <h3 className="text-sm font-semibold text-[#221b16] mb-4">Rating Distribution</h3>
        ...
        <div className="rounded-2xl border border-[#e4d6c8]/60 bg-white shadow-sm overflow-hidden">
          <div className="flex items-center justify-between border-b border-[#e4d6c8]/30 px-6 py-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-[Fraunces] text-lg font-bold text-[#221b16]">All Reviews</h2>
            ...
            <div className="flex items-center gap-1.5">
              ...
              {[null, 5, 4, 3, 2, 1].map(s => (
                <button key={s ?? 'all'} onClick={() => setRatingFilter(s)}
                  className={`px-2.5 py-1 rounded-lg text-[10px] font-semibold transition ${ratingFilter === s ? 'bg-[#221b16] text-white' : 'text-[#8c7564] hover:bg-[#f9f5f0]'}`}>
                  {s ?? 'All'}
                </button>
              ))}
            </div>
          ...
          {isLoading ? (
            ...
            <div className="divide-y divide-[#e4d6c8]/20">
              {filteredReviews.map(r => (
                <div key={r.id} className="px-6 py-5 hover:bg-[#faf6f2] transition">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <p className="text-sm font-semibold text-[#221b16]">{r.reviewer?.displayName || 'Anonymous'}</p>
